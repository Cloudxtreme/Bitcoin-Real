...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/bitcoinreal-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/bitcoinreal-cli.cpp \
           src/bitcoinreal-tx.cpp \
           src/bitcoinreal.cpp \
           src/db.cpp \
           ...
           src/qt/bitcoinreal.cpp \
           src/qt/bitcoinrealstrings.cpp \
...
RESOURCES += src/qt/bitcoinreal.qrc src/qt/bitcoinreal_locale.qrc

TRANSLATIONS += src/qt/locale/bitcoinreal_bg.ts \
                src/qt/locale/bitcoinreal_de.ts \
                src/qt/locale/bitcoinreal_en.ts \
                src/qt/locale/bitcoinreal_es.ts \
                src/qt/locale/bitcoinreal_fi.ts \
                src/qt/locale/bitcoinreal_fr.ts \
                src/qt/locale/bitcoinreal_it.ts \
                src/qt/locale/bitcoinreal_ja.ts \
                src/qt/locale/bitcoinreal_pl.ts \
                src/qt/locale/bitcoinreal_pt.ts \
                src/qt/locale/bitcoinreal_ru.ts \
                src/qt/locale/bitcoinreal_sk.ts \
                src/qt/locale/bitcoinreal_sv.ts \
                src/qt/locale/bitcoinreal_vi.ts \
                src/qt/locale/bitcoinreal_zh_CN.ts \
                src/qt/locale/bitcoinreal_zh_TW.ts

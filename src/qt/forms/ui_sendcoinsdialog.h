...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 BR"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 BR"));
        ...
        checkzBR = new QCheckBox(SendCoinsDialog);
        checkzBR->setObjectName(QStringLiteral("checkzCATO"));
        checkzBR->setEnabled(false);

        horizontalLayout_2->addWidget(checkzBR);
        ...
        labelBalance->setText(QStringLiteral("123.456 BR"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelBlockSize->setText(QApplication::translate("SendCoinsDialog", "0 BR", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for Catocoin transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for Catocoin transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        checkzBR->setText(QApplication::translate("SendCoinsDialog", "Anonymized CATO", Q_NULLPTR));

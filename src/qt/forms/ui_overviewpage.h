...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelzBRPercent->setObjectName(QStringLiteral("labelzBRPercent"));
        ...
        labelBRPercent->setObjectName(QStringLiteral("labelBRPercent"));
...
#ifndef QT_NO_TOOLTIP
        labelzBRPercent->setToolTip(QApplication::translate("OverviewPage", "Current percentage of zBR.\n"

...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::BR);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeCatocoinAmount"))
        SoftSetArg("-anonymizecatocoinamount", settings.value("nAnonymizeCatocoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in catocoin.cpp during shotdown to also remove the window positions

...
#ifndef bitcoinreal_CONFIG_H

#define bitcoinreal_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.bitcoinreal.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BitcoinReal Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BitcoinReal Core 4.1.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitcoinreal"
